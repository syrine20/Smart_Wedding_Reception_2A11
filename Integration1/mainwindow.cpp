...
void MainWindow::on_marketing_2_clicked()
{
       ui->pages->setCurrentIndex(20);
}
...
void MainWindow::recherche(Ui::MainWindow *ui)
{
        QSqlQuery q;
...
void MainWindow::TRI_ID(Ui::MainWindow *ui)
{
       QSqlQuery q;
       QSqlQueryModel *model=new QSqlQueryModel();
...
void MainWindow::TRI_Categorie(Ui::MainWindow *ui)
{
       QSqlQuery q;
       QSqlQueryModel *model=new QSqlQueryModel();
...
void MainWindow::TRI_Prix(Ui::MainWindow *ui)
{
    QSqlQuery q;
    QSqlQueryModel *model=new QSqlQueryModel();
...
void MainWindow::on_pushButton__valider_promotions_ajouter_clicked()
{
...
void MainWindow::on_pushButton_modif_promotions_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
...
void MainWindow::on_pushButton_supp_promotions_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
         player->setMedia(QUrl::fromLocalFile("C:/Users/LENOVO/Desktop/marketing/button.mp3"));
         player->setVolume(2000);
...
void MainWindow::on_pushButton_valider_Packs_ajouter_clicked()
{
    QMediaPlayer *player = new QMediaPlayer;
    player->setMedia(QUrl::fromLocalFile("C:/Users/LENOVO/Desktop/marketing/button.mp3"));
    player->setVolume(2000);
...
void MainWindow::on_pushButton_modif_pack_clicked()
{
    QSqlQuery qry ;
...
void MainWindow::on_pushButton_supp_pack_clicked()
{
...
void MainWindow::on_pushButton_rechercher_packs_clicked()
{

        recherche(ui);
}

void MainWindow::on_pushButton_tri_pack_ID_clicked()
{
    TRI_ID(ui);
}

void MainWindow::on_pushButton_tri_id_pack_inverse_clicked()
{
    ui->tableView_packs_consulter->setModel(PA.tri_IDinv());
}

void MainWindow::on_pushButton_tri_categorie_pack_clicked()
{
    TRI_Categorie(ui);
}

void MainWindow::on_pushButton_tri_categorie_pack_inverse_clicked()
{
     ui->tableView_packs_consulter->setModel(PA.tri_Categorieinv());
}

void MainWindow::on_pushButton_tri_pack_prix_clicked()
{
    TRI_Prix(ui);
}

void MainWindow::on_pushButton_tri_prix_pack_inverse_clicked()
{
...
void MainWindow::on_pushButton_imprimer_liste_promotions_clicked()
{
    QPrinter printer;
...
void MainWindow::on_pushButto_ajouter_vente_clicked()
{
...
void MainWindow::on_pushButton_retour_promotions_ajouter_clicked()
{
    ui->pages->setCurrentIndex(16);
}

void MainWindow::on_pushButton_retour_promotions_consulter_clicked()
{
    ui->pages->setCurrentIndex(16);
}

void MainWindow::on_pushButton_retour_packs_ajouter_clicked()
{
    ui->pages->setCurrentIndex(16);
}

void MainWindow::on_pushButton_retour_packs_consulter_clicked()
{
    ui->pages->setCurrentIndex(16);
}

void MainWindow::on_pushButton_retour_ventes_clicked()
{
    ui->pages->setCurrentIndex(16);
}
