...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_LoginPass->setPixmap(QPixmap(QString::fromUtf8(":/ressource/1.jpg")));
        ...
        label_LoginTitre->setGeometry(QRect(350, 150, 251, 41));
        QFont font1;
        ...
        label_loginNom->setGeometry(QRect(340, 240, 261, 31));
        QFont font2;
        ...
        label_4->setGeometry(QRect(370, 330, 191, 31));
        label_4->setFont(font2);
        label_login_role = new QLabel(menu);
        label_login_role->setObjectName(QStringLiteral("label_login_role"));
        label_login_role->setGeometry(QRect(450, 400, 51, 31));
        label_login_role->setFont(font2);
        label_login_role->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        ...
        font4.setBold(true);
        font4.setWeight(75);
        Pdf_invitation->setFont(font4);
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/ressource/pdf.png"), QSize(), QIcon::Normal, QIcon::Off);
        Pdf_invitation->setIcon(icon1);
...
"background-color: rgb(209, 209, 209);"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/ressource/down.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn_trieDec->setIcon(icon2);
...
"background-color: rgb(209, 209, 209);"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/ressource/up.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn_trieAsc->setIcon(icon3);
...
"background-color: rgb(209, 209, 209);"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/ressource/loop.png"), QSize(), QIcon::Normal, QIcon::Off);
        btn_rech_invite->setIcon(icon4);
        ...
        ajouterinvite->setFont(font4);
        ajouterinvite->setStyleSheet(QStringLiteral("color:black;"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/ressource/add.png"), QSize(), QIcon::Normal, QIcon::Off);
        ajouterinvite->setIcon(icon5);
        ...
        modifierinvite->setFont(font4);
        modifierinvite->setStyleSheet(QStringLiteral("color:black;"));
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/ressource/settings.png"), QSize(), QIcon::Normal, QIcon::Off);
        modifierinvite->setIcon(icon6);
        ...
        supprimerinvite->setFont(font4);
        supprimerinvite->setStyleSheet(QStringLiteral("color:black;"));
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/ressource/Delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        supprimerinvite->setIcon(icon7);
...
"background-color: rgb(209, 209, 209);"));
        btn_triefdescMariage->setIcon(icon2);
        ...
        ajouterMariage->setFont(font4);
        ajouterMariage->setStyleSheet(QStringLiteral("color:black;"));
        ajouterMariage->setIcon(icon5);
...
"background-color: rgb(209, 209, 209);"));
        btn_triefascMariage->setIcon(icon3);
...
"background-color: rgb(209, 209, 209);"));
        btn_rechfMariage->setIcon(icon4);
        ...
        modifierMariage->setFont(font4);
        modifierMariage->setStyleSheet(QStringLiteral("color:black;"));
        modifierMariage->setIcon(icon6);
        ...
        supprimerMariage->setFont(font4);
        supprimerMariage->setStyleSheet(QStringLiteral("color:black;"));
        supprimerMariage->setIcon(icon7);
        ...
        ExcelMariage->setFont(font4);
        ExcelMariage->setStyleSheet(QStringLiteral("color:black;"));
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/ressource/execel.png"), QSize(), QIcon::Normal, QIcon::Off);
        ExcelMariage->setIcon(icon8);
...
"border-color: rgb(255, 255, 255);"));
        ...
        gerer_salle->setGeometry(QRect(160, 230, 161, 51));
...
"border-color: rgb(255, 255, 255);"));
        ...
        gerer_decorateur->setGeometry(QRect(120, 310, 241, 51));
...
"font: 16pt \"Sachiko\";\n"
"border-color: rgb(255, 255, 255);"));
        organisation_4 = new QPushButton(sousmenu_administrateur);
        organisation_4->setObjectName(QStringLiteral("organisation_4"));
        organisation_4->setGeometry(QRect(140, 470, 250, 70));
        organisation_4->setStyleSheet(QLatin1String("background-image: url(:/ressource/mariage.jpg);\n"
"color: rgb(255, 255, 255);\n"
"font: 16pt \"Sachiko\";\n"
"border-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        organisation_4->setText(QApplication::translate("MainWindow", "Ressources Humaines", Q_NULLPTR));
    } // retranslateUi
